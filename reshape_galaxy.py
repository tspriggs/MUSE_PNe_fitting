...
clean_hdulist = fits.open(galaxy_data["Galaxy name"] + "_data/" + galaxy_data["Galaxy name"] +"_gandalf-cleaned_SPAXEL.fits")
...
empty_gal = np.zeros((len(wavelength), raw_shape[1], raw_shape[2], ))
