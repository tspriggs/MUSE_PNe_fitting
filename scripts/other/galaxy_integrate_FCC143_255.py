galaxy_name = "FCC143"
with fits.open(f"/local/tspriggs/Fornax_data_cubes/{galaxy_name}center.fits") as hud:
...
L_bol = ppxf_L_tot(int_spec=gal_lin, header=h1, redshift=z, vel=gal_vel, dist_mod=lit_dM)
