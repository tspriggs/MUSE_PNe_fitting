...
params.add("Amp_Ha",value=30., min=0.001)
#params.add("Amp_NII_1",value=1., min=0.001, vary=False)
#params.add("Amp_NII_2",value=1., min=0.001, vary=False)
...
best_fit_A = np.zeros((len(raw_data_list),4))
